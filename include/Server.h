...
typedef struct PeerData
{
	...
	bool voted;
	bool disconnecting;
	bool spectating; //watching the running match from the waiting lobby
...
typedef struct
{
	...
	uint8_t bring_loc;
	uint8_t jp_gamble_failed_rolls;
	bool jp_gamble_opened;
	uint16_t jp_door_ids[2];
